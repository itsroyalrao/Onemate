  ...
  return (
    <>
      <div className="bg-gradient-to-r from-red-600 to-blue-600 min-h-screen flex flex-col items-center justify-center">
        <div
          id="signup-block"
          className="w-72 h-[17rem] bg-blue-900 flex flex-col items-center rounded-3xl shadow-lg shadow-blue-800"
        >
          <img
          ...
          <div className="flex flex-col items-center py-16 space-y-2">
            ...
            <div className="flex w-full py-2 text-sm text-white">
              <div className="mx-auto">
                <span className="">Already have an account? </span>
                <Link
                  className="cursor-pointer sm:hover:text-red-400 underline"
                  to={"/"}
                >
                  Login
                </Link>
...
function displayMessage(message) {
  ...
  signupBlock.className =
    "w-64 h-[18.5rem] bg-blue-900 flex flex-col items-center rounded-3xl shadow-lg shadow-blue-800";
}
